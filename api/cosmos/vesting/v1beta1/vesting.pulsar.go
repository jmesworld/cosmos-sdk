...
var _ protoreflect.List = (*_ForeverVestingAccount_3_list)(nil)

type _ForeverVestingAccount_3_list struct {
	list *[]*v1beta1.Coin
}

func (x *_ForeverVestingAccount_3_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_ForeverVestingAccount_3_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_ForeverVestingAccount_3_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_ForeverVestingAccount_3_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_ForeverVestingAccount_3_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ForeverVestingAccount_3_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_ForeverVestingAccount_3_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ForeverVestingAccount_3_list) IsValid() bool {
	return x.list != nil
}

var (
	md_ForeverVestingAccount                           protoreflect.MessageDescriptor
	fd_ForeverVestingAccount_base_vesting_account      protoreflect.FieldDescriptor
	fd_ForeverVestingAccount_vesting_supply_percentage protoreflect.FieldDescriptor
	fd_ForeverVestingAccount_already_vested            protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_vesting_v1beta1_vesting_proto_init()
	md_ForeverVestingAccount = File_cosmos_vesting_v1beta1_vesting_proto.Messages().ByName("ForeverVestingAccount")
	fd_ForeverVestingAccount_base_vesting_account = md_ForeverVestingAccount.Fields().ByName("base_vesting_account")
	fd_ForeverVestingAccount_vesting_supply_percentage = md_ForeverVestingAccount.Fields().ByName("vesting_supply_percentage")
	fd_ForeverVestingAccount_already_vested = md_ForeverVestingAccount.Fields().ByName("already_vested")
}

var _ protoreflect.Message = (*fastReflection_ForeverVestingAccount)(nil)

type fastReflection_ForeverVestingAccount ForeverVestingAccount

func (x *ForeverVestingAccount) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ForeverVestingAccount)(x)
}

func (x *ForeverVestingAccount) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_ForeverVestingAccount_messageType fastReflection_ForeverVestingAccount_messageType
var _ protoreflect.MessageType = fastReflection_ForeverVestingAccount_messageType{}

type fastReflection_ForeverVestingAccount_messageType struct{}

func (x fastReflection_ForeverVestingAccount_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ForeverVestingAccount)(nil)
}
func (x fastReflection_ForeverVestingAccount_messageType) New() protoreflect.Message {
	return new(fastReflection_ForeverVestingAccount)
}
func (x fastReflection_ForeverVestingAccount_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ForeverVestingAccount
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ForeverVestingAccount) Descriptor() protoreflect.MessageDescriptor {
	return md_ForeverVestingAccount
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_ForeverVestingAccount) Type() protoreflect.MessageType {
	return _fastReflection_ForeverVestingAccount_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ForeverVestingAccount) New() protoreflect.Message {
	return new(fastReflection_ForeverVestingAccount)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ForeverVestingAccount) Interface() protoreflect.ProtoMessage {
	return (*ForeverVestingAccount)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_ForeverVestingAccount) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.BaseVestingAccount != nil {
		value := protoreflect.ValueOfMessage(x.BaseVestingAccount.ProtoReflect())
		if !f(fd_ForeverVestingAccount_base_vesting_account, value) {
			return
		}
	}
	if x.VestingSupplyPercentage != "" {
		value := protoreflect.ValueOfString(x.VestingSupplyPercentage)
		if !f(fd_ForeverVestingAccount_vesting_supply_percentage, value) {
			return
		}
	}
	if len(x.AlreadyVested) != 0 {
		value := protoreflect.ValueOfList(&_ForeverVestingAccount_3_list{list: &x.AlreadyVested})
		if !f(fd_ForeverVestingAccount_already_vested, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_ForeverVestingAccount) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.base_vesting_account":
		return x.BaseVestingAccount != nil
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.vesting_supply_percentage":
		return x.VestingSupplyPercentage != ""
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.already_vested":
		return len(x.AlreadyVested) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.vesting.v1beta1.ForeverVestingAccount"))
		}
		panic(fmt.Errorf("message cosmos.vesting.v1beta1.ForeverVestingAccount does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ForeverVestingAccount) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.base_vesting_account":
		x.BaseVestingAccount = nil
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.vesting_supply_percentage":
		x.VestingSupplyPercentage = ""
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.already_vested":
		x.AlreadyVested = nil
	default:
		if fd.IsExtension() {
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_ForeverVestingAccount) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.base_vesting_account":
		value := x.BaseVestingAccount
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.vesting_supply_percentage":
		value := x.VestingSupplyPercentage
		return protoreflect.ValueOfString(value)
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.already_vested":
		if len(x.AlreadyVested) == 0 {
			return protoreflect.ValueOfList(&_ForeverVestingAccount_3_list{})
		}
		listValue := &_ForeverVestingAccount_3_list{list: &x.AlreadyVested}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.vesting.v1beta1.ForeverVestingAccount"))
		}
		panic(fmt.Errorf("message cosmos.vesting.v1beta1.ForeverVestingAccount does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ForeverVestingAccount) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.base_vesting_account":
		x.BaseVestingAccount = value.Message().Interface().(*BaseVestingAccount)
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.vesting_supply_percentage":
		x.VestingSupplyPercentage = value.Interface().(string)
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.already_vested":
		lv := value.List()
		clv := lv.(*_ForeverVestingAccount_3_list)
		x.AlreadyVested = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.vesting.v1beta1.ForeverVestingAccount"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ForeverVestingAccount) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.base_vesting_account":
		if x.BaseVestingAccount == nil {
			x.BaseVestingAccount = new(BaseVestingAccount)
		...
		return protoreflect.ValueOfMessage(x.BaseVestingAccount.ProtoReflect())
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.already_vested":
		if x.AlreadyVested == nil {
			x.AlreadyVested = []*v1beta1.Coin{}
		}
		value := &_ForeverVestingAccount_3_list{list: &x.AlreadyVested}
		return protoreflect.ValueOfList(value)
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.vesting_supply_percentage":
		panic(fmt.Errorf("field vesting_supply_percentage of message cosmos.vesting.v1beta1.ForeverVestingAccount is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.vesting.v1beta1.ForeverVestingAccount"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_ForeverVestingAccount) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.base_vesting_account":
		m := new(BaseVestingAccount)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	...
	case "cosmos.vesting.v1beta1.ForeverVestingAccount.already_vested":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_ForeverVestingAccount_3_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.vesting.v1beta1.ForeverVestingAccount"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_ForeverVestingAccount) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.vesting.v1beta1.ForeverVestingAccount", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_ForeverVestingAccount) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ForeverVestingAccount) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_ForeverVestingAccount) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_ForeverVestingAccount) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ForeverVestingAccount)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
		...
		l = len(x.VestingSupplyPercentage)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if len(x.AlreadyVested) > 0 {
			for _, e := range x.AlreadyVested {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.AlreadyVested) > 0 {
			for iNdEx := len(x.AlreadyVested) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.AlreadyVested[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
		...
		if len(x.VestingSupplyPercentage) > 0 {
			i -= len(x.VestingSupplyPercentage)
			copy(dAtA[i:], x.VestingSupplyPercentage)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.VestingSupplyPercentage)))
			i--
			dAtA[i] = 0x12
		}
		if x.BaseVestingAccount != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ForeverVestingAccount: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ForeverVestingAccount: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field VestingSupplyPercentage", wireType)
				}
				...
				x.VestingSupplyPercentage = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field AlreadyVested", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.AlreadyVested = append(x.AlreadyVested, &v1beta1.Coin{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.AlreadyVested[len(x.AlreadyVested)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
type ForeverVestingAccount struct {
	...
	BaseVestingAccount      *BaseVestingAccount `protobuf:"bytes,1,opt,name=base_vesting_account,json=baseVestingAccount,proto3" json:"base_vesting_account,omitempty"`
	VestingSupplyPercentage string              `protobuf:"bytes,2,opt,name=vesting_supply_percentage,json=vestingSupplyPercentage,proto3" json:"vesting_supply_percentage,omitempty"`
	AlreadyVested           []*v1beta1.Coin     `protobuf:"bytes,3,rep,name=already_vested,json=alreadyVested,proto3" json:"already_vested,omitempty"`
}

func (x *ForeverVestingAccount) Reset() {
	*x = ForeverVestingAccount{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_vesting_v1beta1_vesting_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *ForeverVestingAccount) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ForeverVestingAccount) ProtoMessage() {}

// Deprecated: Use ForeverVestingAccount.ProtoReflect.Descriptor instead.
func (*ForeverVestingAccount) Descriptor() ([]byte, []int) {
	return file_cosmos_vesting_v1beta1_vesting_proto_rawDescGZIP(), []int{6}
}

func (x *ForeverVestingAccount) GetBaseVestingAccount() *BaseVestingAccount {
	if x != nil {
		return x.BaseVestingAccount
	}
	return nil
...
func (x *ForeverVestingAccount) GetVestingSupplyPercentage() string {
	if x != nil {
		return x.VestingSupplyPercentage
	}
	return ""
...
func (x *ForeverVestingAccount) GetAlreadyVested() []*v1beta1.Coin {
	if x != nil {
		return x.AlreadyVested
	}
	return nil
}
...
var file_cosmos_vesting_v1beta1_vesting_proto_rawDesc = []byte{
	...
	,
	...
	0x0c, 0x56, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a,
...
var file_cosmos_vesting_v1beta1_vesting_proto_goTypes = []interface{}{
	...
	(*ForeverVestingAccount)(nil),    // 6: cosmos.vesting.v1beta1.ForeverVestingAccount
...
var file_cosmos_vesting_v1beta1_vesting_proto_depIdxs = []int32{
	...
	0,  // 10: cosmos.vesting.v1beta1.ForeverVestingAccount.base_vesting_account:type_name -> cosmos.vesting.v1beta1.BaseVestingAccount
	8,  // 11: cosmos.vesting.v1beta1.ForeverVestingAccount.already_vested:type_name -> cosmos.base.v1beta1.Coin
...
func file_cosmos_vesting_v1beta1_vesting_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_vesting_v1beta1_vesting_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ForeverVestingAccount); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
