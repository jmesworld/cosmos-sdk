...
// provisions values.
func NewMinter(blockHeader cmproto.Header, inflation, annualProvisions sdk.Dec) Minter {
	return Minter{
...
func InitialMinter(blockHeader cmproto.Header, inflation sdk.Dec) Minter {
	return NewMinter(
		blockHeader,
		inflation,
		math.LegacyNewDec(0),
